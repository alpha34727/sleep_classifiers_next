...
def main():
    ...
    for cls_key in outer_bar:
        ...
        for feature_set in FEATURE_SETS:
            ...
            # --- Sleep/Wake (Binary) 50 splits ---
            desc_sw = f"[{cls_name[:12]} | {feat_label}] Binary MC-{args.binary_splits}"
            ...
            # Print a clean, non-flooding message before CV loop
        ...
        # Generate plot curves for each classifier
